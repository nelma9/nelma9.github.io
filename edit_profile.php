...
$number_save=$_POST['number'];
	...
	mysqli_query($connect,"UPDATE user SET firstname ='$first_save', lastname ='$last_save', username ='$username_save', 
...
<br />
		<fieldset class="---------------">
			<legend><h1> Infos personnelles</h1></legend>
			<table cellpadding="5" cellspacing="5">
				<tr>
				...
				<tr>
					...
					<td>
						<select name="genre" class="form-1" value="<?php echo $gender; ?>">
...
<br />		
		<button type="submit" name="save" class="">Sauvegarder</button>
