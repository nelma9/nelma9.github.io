	...
	<div id="header">
		<div class="head-view">
			<ul>
				...
				<li><a href="home.php" title="Home"><label class="active">Accueil</label></a></li>
...
?>	
		<div id="left-nav1">
			...
			<table>
				...
				<tr>
					<td><label>Anne de naissance</label></td>
					<td width="20"></td>
...
<?php
	include("includes/database.php");
			$comment=mysqli_query($connect,"SELECT * from comments where post_id='$post_id' order by post_id DESC") ;
