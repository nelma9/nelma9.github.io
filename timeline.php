...
$time_difference = time() - (float)$session_time ; 
...
<?php include ('session.php');?>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="PostIt"><b>PostIt</b></a></li>
				<li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div>
			<form method="post" enctype="multipart/form-data">
				...
				<button class="btn-share" name="Submit" value="Log out">Partager</button>
			</form>
...
<?php
	include('includes/database.php');
							...
							if ($error > 0){
									...
									$update=mysqli_query($connect," INSERT INTO post (user_id,post_image,content,created)
...
<?php
	include("includes/database.php");
			$query=mysqli_query($connect,"SELECT * from post LEFT JOIN user on user.user_id = post.user_id order by post_id DESC") ;
			while($row=mysqli_fetch_array($query)){
...
<?php
	include("includes/database.php");
			$comment=mysqli_query($connect,"SELECT * from comments where post_id='$post_id' order by post_id DESC") or die(mySQL_error());
...
?>
		 ...
		 <form  method="POST">			
			<div class="comment-area">
						...
						<?php $image=mysqli_query($connect,"select * from user where user_id='$id'");
